#ifndef TCP_SACK_RFC2018_CASE2_DUT_C_H
#define TCP_SACK_RFC2018_CASE2_DUT_C_H
 ...
 */
class test_tcp_sack_dut2tb_c : public test_tcp_sack_c
{

public:
    test_tcp_sack_dut2tb_c(
        ...
        case (check_sack1_s):
        {
            ...
            if (phy->recv_pkt(pkt))
            {
                ...
                if (pkt.meta.tcp.ack != tcb.ini_seq + 500 * lost_blk[0])
                    return false;
                printf("Checking SACK (4 blocks)... Correct. \n");
                state = rtx1_s;
            }
            break;
        }
        ...
        case (check_sack2_s):
        {
            ...
            if (phy->recv_pkt(pkt))
            {
                ...
                if (pkt.meta.tcp.ack != tcb.ini_seq + 500 * lost_blk[1])
                    return false;
                printf("Checking SACK (3 blocks)... Correct. \n");
                state = rtx2_s;
            }
            break;
        }
        ...
        case (check_sack3_s):
        {
            ...
            if (phy->recv_pkt(pkt))
            {
                ...
                if (pkt.meta.tcp.ack != tcb.ini_seq + 500 * lost_blk[2])
                    return false;
                printf("Checking SACK (2 blocks)... Correct. \n");
                state = rtx3_s;
            }
            break;
        }
        ...
        case (check_sack4_s):
        {
            ...
            if (phy->recv_pkt(pkt))
            {
                ...
                if (pkt.meta.tcp.ack != tcb.ini_seq + 500 * lost_blk[3])
                    return false;
                printf("Checking SACK (1 block)... Correct. \n");
                state = rtx4_s;
            }
            break;
        }
        ...
        case (check_ack_s):
        {
            ...
            if (phy->recv_pkt(pkt))
            {
                ...
                if (pkt.meta.tcp.ack != tcb.ini_seq + 11000)
                    return false;
                printf("Ack number OK. SACK removed. Checking payload... ");
